...
export default function FacultySignUpPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await authService.signUpFaculty(email, password, {
        name,
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 w-full">
          ...
          <div>
            <h1 className="text-4xl xl:text-5xl font-bold text-white leading-tight tracking-tight">
              Create your<br />
              faculty portal<br />
              <span className="bg-gradient-to-r from-red-400 to-amber-300 bg-clip-text text-transparent">account.</span>
            </h1>
            <p className="text-zinc-400 mt-6 text-base leading-relaxed max-w-md">
              Register to begin reviewing and approving student graduation requirements directly from your dashboard.
            </p>
        ...
        <div className="w-full max-w-[420px]">
          ...
          {step === 1 && (
            <div className="animate-fade-in">
              ...
              <form onSubmit={handleStep1} className="space-y-5">
                <div>
                  <label htmlFor="signup-email" className="block text-xs font-medium text-zinc-400 mb-2">Faculty Email</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="faculty@usa.edu.ph"
          ...
          {step === 2 && (
            <div className="animate-fade-in">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  <label htmlFor="signup-position" className="block text-xs font-medium text-zinc-400 mb-2">Position</label>
                  <div className="relative">
                    <User className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-600" />
                    <select
                      id="signup-position"
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-[#111114] text-zinc-600">Already have a faculty account?</span>
            </div>
          </div>
