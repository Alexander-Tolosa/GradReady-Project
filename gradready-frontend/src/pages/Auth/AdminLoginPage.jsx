...
import { Shield, Mail, Lock, Eye, EyeOff, ArrowRight, ArrowLeft, Loader2 } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 w-full">
          ...
          <div>
            <h1 className="text-4xl xl:text-5xl font-bold text-white leading-tight tracking-tight">
              Manage clearance<br />
              operations with<br />
              <span className="bg-gradient-to-r from-red-400 to-amber-300 bg-clip-text text-transparent">ease.</span>
            </h1>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-8">
            ...
            <p className="text-zinc-500 text-sm mt-1.5">Access your administrator dashboard</p>
          </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-[#111114] text-zinc-600">New administrator?</span>
            </div>
          </div>
